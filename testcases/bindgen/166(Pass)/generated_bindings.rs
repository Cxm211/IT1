...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of coord"][::std::mem::size_of::<coord>() - 32usize];
    ["Alignment of coord"][::std::mem::align_of::<coord>() - 8usize];
    ["Offset of field: coord::v"][::std::mem::offset_of!(coord, v) - 0usize];
};
unsafe extern "C" {
    #[link_name = "\u{1}__Z10make_coorddddd"]
    pub fn make_coord(x: f64, y: f64, z: f64, t: f64) -> coord;
}
