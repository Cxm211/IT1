...
const _: () = {
    ["Size of Test1"][::std::mem::size_of::<Test1>() - 8usize];
    ["Alignment of Test1"][::std::mem::align_of::<Test1>() - 8usize];
    ["Offset of field: Test1::byte"][::std::mem::offset_of!(Test1, byte) - 6usize];
};
impl Test1 {
    #[inline]
    pub fn foo(&self) -> ::std::os::raw::c_ulong {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 45u8) as u64) }
    }
    #[inline]
    pub fn set_foo(&mut self, val: ::std::os::raw::c_ulong) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set(0usize, 45u8, val as u64)
        }
    }
    #[inline]
    ...
    #[inline]
    pub fn new_bitfield_1(foo: ::std::os::raw::c_ulong) -> __BindgenBitfieldUnit<[u8; 6usize]> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 6usize]> = Default::default();
        __bindgen_bitfield_unit.set(0usize, 45u8, {
