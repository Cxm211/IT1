...
const _: () = {
    ...
    ["Offset of field: timex_named::tai"][::std::mem::offset_of!(timex_named, tai) - 0usize];
};
impl timex_named {
    #[inline]
    ...
    pub unsafe fn a_raw(this: *const Self) -> ::std::os::raw::c_int {
        unsafe {
            ::std::mem::transmute(<__BindgenBitfieldUnit<[u8; 44usize]>>::raw_get(
    ...
    pub unsafe fn set_a_raw(this: *mut Self, val: ::std::os::raw::c_int) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 44usize]>>::raw_set(
