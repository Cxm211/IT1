...
const _: () = {
    ["Size of nsStyleUnion"][::std::mem::size_of::<nsStyleUnion>() - 4usize];
    ["Alignment of nsStyleUnion"][::std::mem::align_of::<nsStyleUnion>() - 4usize];
    ["Offset of field: nsStyleUnion::mInt"][::std::mem::offset_of!(nsStyleUnion, mInt) - 0usize];
