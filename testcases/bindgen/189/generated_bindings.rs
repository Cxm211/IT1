...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of A"][::std::mem::size_of::<A>() - 64usize];
    ["Alignment of A"][::std::mem::align_of::<A>() - 64usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of B"][::std::mem::size_of::<B>() - 192usize];
    ["Alignment of B"][::std::mem::align_of::<B>() - 64usize];
    ["Offset of field: B::a1"][::std::mem::offset_of!(B, a1) - 0usize];
    ["Offset of field: B::a2"][::std::mem::offset_of!(B, a2) - 64usize];
    ["Offset of field: B::x"][::std::mem::offset_of!(B, x) - 128usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct C {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of D"][::std::mem::size_of::<D>() - 128usize];
    ["Alignment of D"][::std::mem::align_of::<D>() - 64usize];
    ["Offset of field: D::c1"][::std::mem::offset_of!(D, c1) - 0usize];
    ["Offset of field: D::c2"][::std::mem::offset_of!(D, c2) - 64usize];
    ["Offset of field: D::x"][::std::mem::offset_of!(D, x) - 67usize];
};
unsafe extern "C" {
